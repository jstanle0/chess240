...
public class ServerFacade {
    ...
    public void joinGame(JoinGameBody body, String authToken) throws ResponseException {
        var req = createRequest("PUT", "/game", body, authToken);
        makeRequest(req, GameData.class);
    }
